...
class PhoneAssignments():
    ...
    def assign(self, phone_id, employee):
        ...
        for phone in self.phones:
            ...
            if phone.id == phone_id and phone.employee_id and not phone.employee_id == employee.id:
                raise PhoneError('phone already assigned to employee')
            
            elif phone.employee_id == employee.id and not phone.id==phone_id:
